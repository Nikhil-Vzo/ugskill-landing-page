...
const courses: CourseItem[] = [
  {
    ...
    icon: <BookOpen className="w-5 h-5 text-[#0052ff]" />,
  },
  {
    id: 2,
    ...
    icon: <Layers3 className="w-5 h-5 text-[#0052ff]" />,
  },
  {
    id: 3,
    ...
    icon: <ClipboardList className="w-5 h-5 text-[#0041cc]" />,
  },
  {
    id: 4,
    ...
    icon: <GraduationCap className="w-5 h-5 text-[#0052ff]" />,
  },
  {
    id: 5,
    ...
    icon: <Sparkles className="w-5 h-5 text-[#0041cc]" />,
  },
  {
    id: 6,
    ...
    icon: <Brain className="w-5 h-5 text-[#0052ff]" />,
  },
];
    ...
    <section
      ...
      style={{
        background: `
          ...
          radial-gradient(ellipse 40% 30% at 90% 95%, rgba(0, 82, 255,0.06) 0%, transparent 50%),
        ...
        {isDesktop ? (
          <div className="grid grid-cols-[1fr_500px] xl:grid-cols-[1fr_560px] gap-8 items-center w-full">
            ...
            <div className="flex flex-col gap-6 pr-8 justify-center py-4">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#0052ff]/8 border border-[#0052ff]/15 text-[#0041cc] text-[10px] font-extrabold tracking-wider uppercase w-fit">
                <Sparkles className="w-3.5 h-3.5" />
                Interactive Sandbox
              </div>
              
              <h3 className="text-4xl lg:text-5xl font-black text-[#0F172A] tracking-tight leading-[1.1] font-sans">
                The Holy <span className="bg-gradient-to-r from-[#0052ff] to-emerald-500 bg-clip-text text-transparent">Knowledge Checkpoint</span>
              </h3>
              ...
              <div className="flex items-start gap-5 mt-4">
                ...
                <div className="relative w-28 h-28 flex-shrink-0 select-none">
                  <div className="absolute inset-1 bg-[#0052ff]/10 rounded-full blur-xl pointer-events-none" />
                  <img
                    src="/assets/student_mascot_clay.png"
                    alt="Student Mascot Guide"
                    className="mascot-float w-full h-auto drop-shadow-[0_8px_16px_rgba(0, 82, 255,0.12)] relative z-10"
                  />
                </div>
                ...
                <div className="relative bg-[#FAFAFA] border border-slate-200/80 rounded-2xl p-4.5 shadow-sm flex-1">
                  ...
                  <p className="text-xs text-slate-500 font-semibold leading-relaxed relative z-10 font-sans">
                    <span className="text-[#0041cc] font-extrabold uppercase tracking-wider text-[9px] block mb-1 font-sans">UG Bot</span>
